...
class ChallengesFragment : Fragment() {
  ...
  private fun setupRecyclerView() {
    ...
    val exampleChallenges =
        mutableListOf<Challenge>(
            Challenge(descripcion = "Realiza un RecyclerView que liste una api de Pokemones"),
            Challenge(descripcion = "Completa el desafío de la botella"),
            Challenge(descripcion = "Diseña la interfaz de usuario"),
        )
